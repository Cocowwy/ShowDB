!function (e, t) {
    ...
    return function (e) {
        ...
        t.__esModule = !0;
        var r = E(24), o = n(r), T = E(25), R = n(T), N = E(26), i = n(N), A = E(27), I = n(A);
        t.default = {
            format: function (e, t) {
        ...
        var n = E(12), r = "object" == typeof self && self && self.Object === Object && self,
        ...
        var r = E(9), o = E(48), T = E(57), R = "[object Null]", N = "[object Undefined]",
        ...
        t.__esModule = !0;
        var o = E(74), T = n(o), R = E(8), N = n(R), i = E(21), A = n(i), I = E(22), O = n(I), u = E(23), S = n(u),
            a = function () {
                function e(t, E) {
        ...
        t.__esModule = !0;
        var o = E(66), T = n(o), R = E(63), N = n(R), i = E(8), A = n(i), I = function () {
            function e(t) {
            ...
            return e.prototype.createLineCommentRegex = function (e) {
                ...
                return this.getTokenOnFirstMatch({input: e, type: A.default.WHITESPACE, regex: this.WHITESPACE_REGEX})
                ...
                return this.getTokenOnFirstMatch({input: e, type: A.default.STRING, regex: this.STRING_REGEX})
            }, e.prototype.getOpenParenToken = function (e) {
                return this.getTokenOnFirstMatch({input: e, type: A.default.OPEN_PAREN, regex: this.OPEN_PAREN_REGEX})
            }, e.prototype.getCloseParenToken = function (e) {
                return this.getTokenOnFirstMatch({input: e, type: A.default.CLOSE_PAREN, regex: this.CLOSE_PAREN_REGEX})
                ...
                return this.getPlaceholderTokenWithKey({
                    ...
                    parseKey: function (e) {
                        return t.getEscapedPlaceholderKey({key: e.slice(2, -1), quoteChar: e.slice(-1)})
                    }
                })
                ...
                var t = e.input, E = e.regex, n = e.parseKey,
                    r = this.getTokenOnFirstMatch({input: t, regex: E, type: A.default.PLACEHOLDER});
                return r && (r.key = n(r.value)), r
            }, e.prototype.getEscapedPlaceholderKey = function (e) {
                var t = e.key, E = e.quoteChar;
                return t.replace(RegExp((0, N.default)("\\") + E, "g"), E)
            }, e.prototype.getNumberToken = function (e) {
                return this.getTokenOnFirstMatch({input: e, type: A.default.NUMBER, regex: this.NUMBER_REGEX})
            }, e.prototype.getOperatorToken = function (e) {
                return this.getTokenOnFirstMatch({input: e, type: A.default.OPERATOR, regex: this.OPERATOR_REGEX})
                ...
                return this.getTokenOnFirstMatch({input: e, type: A.default.RESERVED, regex: this.RESERVED_PLAIN_REGEX})
            }, e.prototype.getWordToken = function (e) {
                return this.getTokenOnFirstMatch({input: e, type: A.default.WORD, regex: this.WORD_REGEX})
            }, e.prototype.getTokenOnFirstMatch = function (e) {
                var t = e.input, E = e.type, n = e.regex, r = t.match(n);
                if (r) return {type: E, value: r[1]}
            }, e
        }();
        ...
        var r = E(9), o = E(33), T = E(15), R = E(19), N = 1 / 0, i = r ? r.prototype : void 0,
        ...
        function E(e) {
            var t = e && e.constructor, E = "function" == typeof t && t.prototype || n;
            return e === E
        }
        ...
        var r = E(2), o = E(6), T = "[object AsyncFunction]", R = "[object Function]", N = "[object GeneratorFunction]",
            i = "[object Proxy]";
        e.exports = n
    }, function (e, t) {
        function E(e) {
        ...
        var r = E(2), o = E(7), T = "[object Symbol]";
        e.exports = n
    }, function (e, t) {
        ...
        t.__esModule = !0;
        var o = E(69), T = n(o), R = E(68), N = n(R), i = "top-level", A = "block-level", I = function () {
            function e(t) {
        ...
        t.__esModule = !0;
        var o = E(8), T = n(o), R = 50, N = function () {
            function e() {
            ...
            return e.prototype.beginIfPossible = function (e, t) {
                ...
                for (var E = 0, n = 0, r = t; e.length > r; r++) {
                    ...
                    if (o.type === T.default.OPEN_PAREN) n++; else if (o.type === T.default.CLOSE_PAREN && (n--, 0 === n)) return !0;
                    if (this.isForbiddenToken(o)) return !1
                }
                return !1
            }, e.prototype.isForbiddenToken = function (e) {
                var t = e.type, E = e.value;
        ...
        var n = E(3), r = E(1), o = n(r, "DataView");
        e.exports = o
    }, function (e, t, E) {
        var n = E(3), r = E(1), o = n(r, "Map");
        e.exports = o
    }, function (e, t, E) {
        var n = E(3), r = E(1), o = n(r, "Promise");
        e.exports = o
    }, function (e, t, E) {
        var n = E(3), r = E(1), o = n(r, "Set");
        e.exports = o
    }, function (e, t, E) {
        var n = E(3), r = E(1), o = n(r, "WeakMap");
        e.exports = o
    }, function (e, t) {
        function E(e, t) {
        ...
        function E(e, t, E, n) {
            for (var r = e.length, o = E + (n ? 1 : -1); n ? o-- : ++o < r;) if (t(e[o], o, e)) return o;
            return -1
        }
        ...
        var r = E(2), o = E(7), T = "[object Arguments]";
        e.exports = n
    }, function (e, t) {
        function E(e) {
            return e !== e
        ...
        var r = E(17), o = E(54), T = E(6), R = E(14), N = /[\\^$.*+?()[\]{}|]/g, i = /^\[object .+?Constructor\]$/,
            A = Function.prototype, I = Object.prototype, O = A.toString, u = I.hasOwnProperty,
        ...
        var r = E(2), o = E(18), T = E(7), R = "[object Arguments]", N = "[object Array]", i = "[object Boolean]",
            A = "[object Date]", I = "[object Error]", O = "[object Function]", u = "[object Map]",
            S = "[object Number]", a = "[object Object]", s = "[object RegExp]", L = "[object Set]",
            c = "[object String]", C = "[object WeakMap]", f = "[object ArrayBuffer]", p = "[object DataView]",
            l = "[object Float32Array]", d = "[object Float64Array]", P = "[object Int8Array]",
            D = "[object Int16Array]", U = "[object Int32Array]", M = "[object Uint8Array]",
            h = "[object Uint8ClampedArray]", _ = "[object Uint16Array]", v = "[object Uint32Array]", y = {};
        ...
        var r = E(13), o = E(55), T = Object.prototype, R = T.hasOwnProperty;
        e.exports = n
    }, function (e, t) {
        function E(e, t) {
            var E = "";
        ...
        var n = E(1), r = n["__core-js_shared__"];
        e.exports = r
    }, function (e, t, E) {
        function n(e) {
            var t = T.call(e, N), E = e[N];
            try {
                e[N] = void 0;
                var n = !0
            } catch (e) {
        ...
        var r = E(9), o = Object.prototype, T = o.hasOwnProperty, R = o.toString, N = r ? r.toStringTag : void 0;
        e.exports = n
    }, function (e, t, E) {
        var n = E(28), r = E(29), o = E(30), T = E(31), R = E(32), N = E(2), i = E(14), A = "[object Map]",
            I = "[object Object]", O = "[object Promise]", u = "[object Set]", S = "[object WeakMap]",
            a = "[object DataView]", s = i(n), L = i(r), c = i(o), C = i(T), f = i(R), p = N;
        (n && p(new n(new ArrayBuffer(1))) != a || r && p(new r) != A || o && p(o.resolve()) != O || T && p(new T) != u || R && p(new R) != S) && (p = function (e) {
            var t = N(e), E = t == I ? e.constructor : void 0, n = E ? i(E) : "";
            if (n) switch (n) {
                case s:
                    return a;
                case L:
        ...
        var n = "\\ud800-\\udfff", r = "\\u0300-\\u036f", o = "\\ufe20-\\ufe2f", T = "\\u20d0-\\u20ff", R = r + o + T,
            N = "\\ufe0e\\ufe0f", i = "\\u200d", A = RegExp("[" + i + n + R + N + "]");
        e.exports = E
    }, function (e, t) {
        function E(e, t) {
            var E = typeof e;
        ...
        var r = E(62), o = E(16), T = E(52), R = E(6);
        e.exports = n
    }, function (e, t, E) {
        function n(e) {
            return !!o && o in e
        ...
        var r = E(47), o = function () {
            var e = /[^.]+$/.exec(r && r.keys && r.keys.IE_PROTO || "");
            return e ? "Symbol(src)_1." + e : ""
        }();
        e.exports = n
    }, function (e, t, E) {
        var n = E(58), r = n(Object.keys, Object);
        e.exports = r
    }, function (e, t, E) {
        (function (e) {
            var n = E(12), r = "object" == typeof t && t && !t.nodeType && t,
                o = r && "object" == typeof e && e && !e.nodeType && e, T = o && o.exports === r, R = T && n.process,
                N = function () {
                    try {
        ...
        function E(e, t, E) {
            for (var n = E - 1, r = e.length; ++n < r;) if (e[n] === t) return n;
            return -1
        }
        ...
        var n = "\\ud800-\\udfff", r = "\\u0300-\\u036f", o = "\\ufe20-\\ufe2f", T = "\\u20d0-\\u20ff", R = r + o + T,
            ...
            O = "(?:" + A + "|" + I + ")", u = "[^" + n + "]", S = "(?:\\ud83c[\\udde6-\\uddff]){2}",
            a = "[\\ud800-\\udbff][\\udc00-\\udfff]", s = "\\u200d", L = O + "?", c = "[" + N + "]?",
            C = "(?:" + s + "(?:" + [u, S, a].join("|") + ")" + c + L + ")*", f = c + L + C,
            p = "(?:" + [u + A + "?", A, S, a, i].join("|") + ")", l = RegExp(I + "(?=" + I + ")|" + p + f, "g");
        e.exports = E
    }, function (e, t) {
        function E(e, t) {
            return e === t || e !== e && t !== t
        ...
        var r = E(10), o = /[\\^$.*+?()[\]{}|]/g, T = RegExp(o.source);
        e.exports = n
    }, function (e, t, E) {
        var n = E(37), r = E(7), o = Object.prototype, T = o.hasOwnProperty, R = o.propertyIsEnumerable,
            N = n(function () {
                return arguments
            }()) ? n : function (e) {
        ...
        (function (e) {
            var n = E(1), r = E(70), o = "object" == typeof t && t && !t.nodeType && t,
                T = o && "object" == typeof e && e && !e.nodeType && e, R = T && T.exports === o,
                N = R ? n.Buffer : void 0, i = N ? N.isBuffer : void 0, A = i || r;
            e.exports = A
        }).call(t, E(20)(e))
    }, function (e, t, E) {
        function n(e) {
            ...
            for (var E in e) if (a.call(e, E)) return !1;
            return !0
        }

        var r = E(41), o = E(49), T = E(64), R = E(15), N = E(16), i = E(65), A = E(13), I = E(67), O = "[object Map]",
            u = "[object Set]", S = Object.prototype, a = S.hasOwnProperty;
        e.exports = n
    }, function (e, t, E) {
        var n = E(40), r = E(44), o = E(56), T = o && o.isTypedArray, R = T ? r(T) : n;
        e.exports = R
    }, function (e, t) {
        function E(e) {
        ...
        var r = E(42), o = E(53), T = E(72), R = E(10);
        e.exports = n
    }, function (e, t) {
        function E() {
            return !1
        ...
        var r = E(73), o = 1 / 0, T = 1.7976931348623157e308;
        e.exports = n
    }, function (e, t, E) {
        function n(e) {
            var t = r(e), E = t % 1;
        ...
        var r = E(6), o = E(19), T = NaN, R = /^\s+|\s+$/g, N = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i,
            A = /^0o[0-7]+$/i, I = parseInt;
        e.exports = n
    }, function (e, t, E) {
        function n(e, t, E) {
            if (e = N(e), e && (E || void 0 === t)) return e.replace(i, "");
            if (!e || !(t = r(t))) return e;
            var n = R(e), A = T(n, R(t)) + 1;
            return o(n, 0, A).join("")
        }

        var r = E(11), o = E(45), T = E(46), R = E(60), N = E(10), i = /\s+$/;
        e.exports = n
    }])
});